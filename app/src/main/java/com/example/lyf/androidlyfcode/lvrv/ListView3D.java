...
public class ListView3D extends AdapterView<Adapter> {
	...
	public ListView3D(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}

	@RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
	public ListView3D(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
